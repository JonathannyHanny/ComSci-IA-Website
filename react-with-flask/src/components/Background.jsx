// Background visual used by several pages. Renders a top background image
// and tint layer and then places child content on top. The component is
// intentionally simple so pages can customize the `image` and `tint` props.
...
const Background = ({ image, tint = 'rgba(91,56,56,0.5)', children }) => {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', position: 'relative', overflowX: 'hidden', background: colors.pageBg }}>
      <div style={{ position: 'absolute', left: 'var(--sidebar-width, 0px)', width: '100%', height: 500 }}>
        ...
        <div style={{ position: 'absolute', left: 0, bottom: '-100vh', width: '100%', height: '100vh', background: colors.pageBg, zIndex: 2 }} />
      </div>
