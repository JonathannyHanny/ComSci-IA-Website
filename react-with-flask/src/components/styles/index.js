// Shared style tokens used across the React UI components.
// Keep this file intentionally small and dependency-free: components
// import these values for consistent colors, spacing and layout tokens.
export const colors = {
  primary: '#39498b',
...
export const cardBody = { background: '#f5f5f5', minHeight: '220px', margin: '24px', padding: '16px', overflowY: 'auto', borderRadius: '8px', boxShadow: 'inset 0 2px 8px rgba(0,0,0,0.08)' };
...
// Tokens used on authentication pages (Log in / Sign up)
...
// Small UI tokens for activity cards, lists and badges
